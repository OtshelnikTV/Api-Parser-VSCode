...
function activate(context) {
    context.subscriptions.push(vscode.commands.registerCommand('apiParser.open', () => __awaiter(this, void 0, void 0, function* () {
        try {
            if (!server) {
...
function startServer(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        serverPort = yield (0, get_port_1.default)({ port: get_port_1.default.makeRange(3000, 3999) });
